                ...
                <section style="color: black;">
                    ...
                    <form action="process/process-signup.php"  method="post" id="signup" novalidate>
                        <div class="mb-3" style="margin-top: 5vh;">
                          ...
                          id="email" name="email" aria-describedby="emailHelp" style="border-radius: 100px; height: 5vh;">
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Password</label>
                          <input type="password" class="form-control" 
                          id="password" name="password" style="border-radius: 100px; height: 5vh;">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword2" class="form-label">Confirm Password</label>
                            <input type="password" class="form-control" 
                            id="password_confirmation" name="password_confirmation" style="border-radius: 100px; height: 5vh;">
                          </div>
