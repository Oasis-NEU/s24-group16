        ...
        <section>
            <div class="d-flex font-primary">
                ...
                <div class=" mx-5" style="padding-left: 5vw;">
                    ...
                    style="font-size: 3.5vh; margin-top: 20px;">Add your hobbies, social media, availability,
                    ...
                    <p class="font-secondary" 
                    style="font-size: 3.5vh; margin-top: 20px;">Search our extensive database, add your classes
                    ...
                    <p class="font-secondary" 
                    style="font-size: 3.5vh; margin-top: 20px;">Search for buddies from your classes page
        ...
        <div class="font-primary text-center">
            ...
            <div class="row align-items-center" style="width: 90vw; margin: auto; margin-bottom: 150px; ">
                <div class="col">
                    ...
                    <h2 style="font-weight: 800; margin-top: 30px; margin-bottom: 40px; font-size: 5vh;">Profile Customization</h2>
                ...
                <div class="col">
                    ...
                    <p style="padding-left: 1vw; padding-right: 1vw; font-size: 3.4vh;"> Easily find the classes you're in from our
